...
def setup_product():
    ...
    import svmetal.checkVisitor
    zcml.load_config('configure.zcml', svmetal.checkVisitor)
    ...
    ztc.installPackage('svmetal.checkVisitor')
...
setup_product()
ptc.setupPloneSite(products=['svmetal.checkVisitor'])
